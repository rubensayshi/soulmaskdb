  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60" onClick={onCancel}>
      ...
      >
        ...
        <div className="text-[13px] text-text-mute mb-3">
          {isSelect
        ...
        <div className="max-h-40 overflow-y-auto mb-3 flex flex-col gap-0.5">
          {nodes.map(n => (
            <div key={n.id} className="flex items-center gap-2 text-[13px] px-2 py-1 bg-panel rounded">
        ...
        <div className="flex gap-2 justify-end">
          <button
            onClick={onCancel}
            className="px-3 py-1 text-[13px] border border-hair text-text-mute hover:text-text transition-colors"
          >
            Cancel
          </button>
          <button
